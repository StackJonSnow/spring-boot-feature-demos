...
import com.example.druid.datasource.service.MysqlOperateService;
...
@SpringBootTest
class DynamicDruidDatasourceDemoApplicationTests {

	@Autowired
	private MysqlOperateService mysqlOperateService;

	private final Logger LOGGER = LoggerFactory.getLogger(DynamicDruidDatasourceDemoApplicationTests.class);
